...
function HeroSection() {
    ...
    return (
          <div className="mt-12 md:mt-24 inset-0 bg-white bg-opacity-80 flex justify-center items-center">
            <div className=" p-3 md:p-8 rounded-lg flex justify-top flex-col">
