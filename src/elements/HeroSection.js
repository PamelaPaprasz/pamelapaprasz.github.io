      ...
      <div className="md:flex md:items-center">
        <div className="md:w-2/3">
          <p className="text-[12px] lg:text-sm leading-loose  mb-2 md:mb-3 lg:mb-4 uppercase whitespace-normal">
            ...
            <span className="border-r border-darkBeige px-2 py-0.5 whitespace-no-wrap">Frontend Development</span>
            <span className=" pl-2 py-0.5 whitespace-no-wrap">UX Design</span>
          </p>

          <h1 className="text-gray-700 text-4xl md:text-6xl lg:text-8xl font-bold mb-7 md:mb-12 lg:mb-16 leading-10">Turning ideas into reality.</h1>
          <hr className="md:w-80 h-0.5 bg-darkBeige mb-4 md:mb-7 lg:mb-9" /> {/* Separator Line */}
          <p className="text-gray-700 text-lg md:text-2xl lg:text-3xl mb-4">Pamela Paprasz, Vienna based designer, crafting awesome apps and tools for folks like you.</p>
        </div>
